...
var stateSelect = ["All States","AL", "AR", "AZ", "CA", "CO", "CT", "DC","DE", "FL", "GA", "IA","ID", "IL", "IN",  "KS", "KY", "LA", "MA", "MD", "MI", "MN", "MO", "NC", "ND", "NE", "NJ", "NY", "OH", "OK", "OR", "PA", "RI", "TN", "TX", "VA", "WA", "WI"]
...
d3.json("assets/fortune500_2021nae.json").then(function(data) {
...
var mousemove = function(d) {
  ...
  d3.select(this).attr(
    ...
    d3.select("#tooltip #tpRev")
      .text("Revenue (Million): $" + format(d.data.revenue2021))
