...
var w = (window.innerWidth)*.5, h = (window.innerHeight)

if (window.innerWidth>650) {
  w = (window.innerWidth)*.5,
  h = (window.innerHeight*.9)
} else {w = (window.innerWidth)*.9,
...
function change(data){
  ...
  var simulation = d3.forceSimulation()
            ...
            .force("x", d3.forceX().x(w))
            .force("y", d3.forceY().y(h));
  ...
  data.forEach(function(d){
        ...
        svg2.selectAll('.STEMdot')    
            ...
            div.transition() 
             ...
             div.html(d.stemText + "<br/>Total:  "  + d.stemNumber)
                .style("left", mouseX +w*.2 +"px")
                .style("top",  mouseY +h*.05 +"px")
                .style("visibility", "visible")
                .style("color", "black");  
            })          
              .on("mouseout", function(d) {   
        ...
        function FieldNew() {
          ...
          svg2.selectAll('circle')
              ...
              .attr("cx", function(d){ 
                  ...
                  else {return (d.x)+w*.05;}
              })
              .attr("cy", function(d){ 
                  if (d.FieldNew == "0") {return d.y + h*.18;}
                  else if (d.FieldNew == '2'||d.FieldNew == '4'||d.FieldNew == '6'||d.FieldNew == '8'){return (d.y+h*.1) }
      ...
      svg2.append("text")
        ...
        .attr('class', "shortage")
        .attr('fill', 'black')
        .text('Top Occupations without Shortages');
        ...
        function professionExtra2() {
          ...
          svg2.selectAll('circle')
              ...
              .duration(100)
              .attr('class', "profession")
              .attr("r", function(d){ if (d.postsecondary == "0" && d.professionExtra2 != "0") {return d.r-.5;} else if (d.postsecondary == "1") {return d.r+5;} else {return 1}})
              .attr("cx", function(d){
      ...
      function professionExtra3(){
         ...
         function engineering() {
          ...
          svg2.selectAll('circle')
              ...
              .duration(100)
              .attr('class', "profession")
              .attr("r", function(d){ if (d.engineering == "0" && d.professionExtra3 != "0") {return d.r-.5;} else if (d.engineering == "1") {return d.r+5;} else {return 1}})
              .attr("cx", function(d){
                if (d.professionExtra2 == '1' && d.engineering =='1') {return (d.x);} 
