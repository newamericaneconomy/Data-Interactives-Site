...
var width = (window.innerWidth*.75), height = (window.innerHeight*.67)
...
d3.json("assets/fortune5002019imm.json").then(function(data) {
 ...
 var root = d3.hierarchy(data)
  ...
  cell.append("title")
      .text(function(d) { return d.data.companyName + "\nRevenue (Million): $" + format(d.data.revenue2019) + "\nEmployees: " + format(d.data.employees) + '\nRank: ' +d.data.rank; });
