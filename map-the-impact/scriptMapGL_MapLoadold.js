...
var msaData = d3.csv("acs_data/msaData_2017.csv")
        ...
        // location of the feature, with description HTML from its properties.
            ...
            map.on('click', 'district-fills', function(e) {
                ...
                sidebarSummary.innerHTML = "<div class='mti_tooltip_text_cont'>" +
                        ...
                        "</div>"+
                        "<div class='source-line'>Source: 5-year 2018 American Community Survey</div>"+
...
map.addControl(geocoder);
  ...
  geocoder.on('result', function(e) {
      ...
      var searchCoor = projection(e.result.geometry.coordinates)

      var newCoor = [searchCoor[0], -1*searchCoor[1]]

      if (e.result.properties.id > 0) {
          if (clickedStateId) {
              map.setFeatureState(
                  { source: 'district', id: clickedStateId },
                  { click: false }
          ...
          clickedStateId = e.result.properties.id;
          map.setFeatureState(
              { source: 'district', id: clickedStateId},
              { click: true }
          );
